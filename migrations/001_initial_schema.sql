...
-- Description: Initial database schema for Zero Point Labs Dashboard
-- Date: 2024-12-31
...
CREATE INDEX IF NOT EXISTS idx_analytics_client_date ON analytics_data(client_id, date DESC);
...
CREATE INDEX IF NOT EXISTS idx_visitor_sessions_client ON visitor_sessions(client_id);
CREATE INDEX IF NOT EXISTS idx_visitor_sessions_date ON visitor_sessions(created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_page_views_client ON page_views(client_id);
CREATE INDEX IF NOT EXISTS idx_page_views_timestamp ON page_views(timestamp DESC);

-- ====================================
-- SAMPLE DATA
-- ====================================
INSERT OR IGNORE INTO clients (id, name, email, website_url, client_code) VALUES 
